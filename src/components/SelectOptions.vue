<template>
  <div
    ...
    <transition name="fade">
      <div v-if="visible" class="absolute top-12 left-0 bg-black w-full rounded-md overflow-hidden py-2 z-20">
        <div
          v-for="(localeItem, index) in optionsList"
          :key="index"
          :class="currentOptions === localeItem.value ? 'bg-permaBlack5' : ''"
